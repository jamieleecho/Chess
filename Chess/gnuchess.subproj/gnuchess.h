...
/*
  ...
  Just a little clean-up along with gnuchess.c changes.  The original is saved
  in gnuchess.save folder.
*/
...
extern short quit,reverse,bothsides,hashflag,InChk,player,force,easy,chess_beep,meter;
extern short chess_timeout,xwndw;
